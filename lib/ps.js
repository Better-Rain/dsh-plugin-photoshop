...
try {
  ...
  [System.IO.File]::WriteAllText($StatusPath, 'PHOTOSHOP_UNAVAILABLE: ' + $_.Exception.Message, $utf8)
  exit 2
}
try {
  $code = [System.IO.File]::ReadAllText($JsxPath, [System.Text.Encoding]::UTF8)
  [void]$app.DoJavaScript($code)
  [System.IO.File]::WriteAllText($StatusPath, 'OK', $utf8)
} catch {
  [System.IO.File]::WriteAllText($StatusPath, 'SCRIPT_ERROR: ' + $_.Exception.Message, $utf8)
  exit 1
} finally {
