...
export const VOCABULARY = [
  {
    ...
    operations: [
      ...
      { name: 'flatten', params: '', summary: 'Flatten all layers into one. Every transparent pixel is filled with pure white, which makes this the one-step way to put a cutout on a white background.' },
