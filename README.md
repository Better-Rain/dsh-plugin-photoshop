...
| 组 | 数量 | 覆盖 |
| --- | --- | --- |
| `document` | 15 | 打开/新建/关闭/另存、缩放、画布、裁剪、旋转、翻转、裁边、拼合、合并、复制、色彩模式、配置文件 |
| `layer` | 21 | 新建/删除/复制/重命名/移动/编组/解组、不透明度、填充不透明度、混合模式、可见性、锁定、解锁背景、栅格化、智能对象、向下合并、蒙版增删应用反相、剪贴蒙版、图层样式 |
